...
async function getMissionDataPerYearData () {
    const URL = 'https://app.amexpert.pro:4443/dashboard/missionperyear'
...
async function getAmountWorkedPerYear (type="bar") {
    const URL = 'https://app.amexpert.pro:4443/dashboard/missionencashyear'
    const response = await fetch(URL)
    const datapoints = await response.json()
    return datapoints
}
...
async function getMissionsPerMonth () {
    const URL = 'https://app.amexpert.pro:4443/dashboard/missionpermonth'
    const response = await fetch(URL)
    const datapoints = await response.json()
    return datapoints
}
